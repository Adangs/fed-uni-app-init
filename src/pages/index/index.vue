  ...
  <view class="m-demo-all">
    ...
    <view class="m-demo-content">
      ...
      <view class="image">
        ...
        <view class="li">
          <x-image src="/assets/images/red_share.jpg" />
        </view>
        <view class="li">
          <view class="bg-img">css引用的外部背景图片，使用cdn('/assets/images/red_share.jpg')</view>
        </view>
      </view>
...
<style lang="scss">
  .m-demo-content{
    ...
    .image{
      ...
      .bg-img{ height: 100%; background: cdn('/assets/images/red_share.jpg') no-repeat; word-break: break-all;}
    }
    .goods{
